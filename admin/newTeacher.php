...
function connect()
{
  ...
  if(isset($_POST["insert"]))
  {
    ...
    $createdBy =  $_SESSION['vpmsaid'];
     ...
     $sql = "INSERT INTO user (loginID, password, name, dob, email, contact, address, startDate, role, status, createdBy) VALUES ('$loginid', '$password', '$name', '$dob', '$email', '$contact', '$address', '$sdate', '$role', '$status', '$createdBy')";
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="teacherRecord.php">Teacher Record</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Add Teacher</strong>
                </div>
                <div class="card-body">
                <form action="newTeacher.php" method="post" autocomplete="on"> 
                    ...
                    <tr hidden>
                        <th>Role:</th>
                        <td><input type="text" class="form-control" id="role" name="role" value="2" readonly hidden></td>
                    </tr>
                    ...
                    <button type="submit" class="btn btn-primary" name="insert" style="width:250px;margin-left:35%;margin-bottom:3%;background: palevioletred;border: 1px solid transparent;cursor: pointer;font-size: 20px;" onMouseOver="this.style.background='rgba(253,187,45,1)'" 
                              onMouseOut="this.style.background='palevioletred'">Add Teacher</button>
                    </div>
                </div> 
</form>
