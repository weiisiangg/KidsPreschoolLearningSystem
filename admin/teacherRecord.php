...
if(isset($_POST['update']))
{
    ...
    header("Location: teacherRecord.php?insertSuccess");
}
...
<html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Teacher Record</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    <div class= "container">
        <div class="justify-content-center">
            <h2> <strong>Teacher Record</strong> <h2><br>
        </div>
    ...
    <div class ="row justify-content-center">
        <table class="table">
            ...
            <?php
                 $i = 1;
                 $res=mysqli_query($link,"select * from user where role = '2'");
        ...
        <input type="button" class="button-active" style="width:250px; margin-left:5%; margin-bottom:3%; border-radius:5px; border: 1px solid transparent;
                    ...
                    onMouseOut="this.style.background='palevioletred'" onclick="location.href='newTeacher.php'" value="Create a new teacher">    
    </div>
</div>
